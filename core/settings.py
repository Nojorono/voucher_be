...
Generated by 'django-admin startpCORS_ALLOW_ALL_ORIGINS = True
CORS_ALLOWED_ORIGINS = [
    "http://localhost:5173",    # Vite dev server
    "http://localhost:8080",    # Docker frontend local (matches .env FRONTEND_URL)
    "http://localhost:8082",    # Backend local (matches .env API_BASE_URL)
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://localhost:8080",    # Backend through nginx
]
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '0.0.0.0', 'ryo_backend']
...
CSP_CONNECT_SRC = (
    "'self'", 
    "http://localhost:8082",    # Updated to match .env API_BASE_URL
    "http://localhost:5173",    # Vite dev server
    "http://localhost:8080",    # Updated to match .env FRONTEND_URL
    "http://10.0.3.222:8082",   # AWS backend
    "http://10.0.3.222:8080",   # AWS frontend
    "http://10.0.3.222",
